...
{	
	...
	if ( level.script == "zm_zod" )
		zm_perk_utility::place_perk_machine( ( 1992, -3417, -400 ), ( 0, 180 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
	if ( level.script == "zm_factory" )
		zm_perk_utility::place_perk_machine( ( 63, -1464, 191 ), ( 0, 90 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
	if ( level.script == "zm_castle" )
		zm_perk_utility::place_perk_machine( ( 1502, 3094, 408 ), ( 0, -163 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
	if ( level.script == "zm_island" )
		zm_perk_utility::place_perk_machine( ( 1684, 908, -4399 ), ( 0, 90 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
	if ( level.script == "zm_stalingrad" )
		zm_perk_utility::place_perk_machine( ( -905, 3335, 160 ), ( 0, -90 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
	if ( level.script == "zm_genesis" )
		zm_perk_utility::place_perk_machine( ( -82, -411, -3381 ), ( 0, 0 + 90, 0 ), PERK_ELECTRIC_CHERRY, ELECTRIC_CHERRY_MACHINE_DISABLED_MODEL );
}
