...
{	
	...
	// if ( level.script == "zm_factory" )
	// 	zm_perk_utility::place_perk_machine( ( -704, -1048, 200 ), ( 0, 0, 0 ), PERK_WIDOWS_WINE, WIDOWS_WINE_MACHINE_DISABLED_MODEL );
	// if ( level.script == "zm_castle" )
	// 	zm_perk_utility::place_perk_machine( ( -1187, 2996, 280 ), ( 0, 0, 0 ), PERK_WIDOWS_WINE, WIDOWS_WINE_MACHINE_DISABLED_MODEL );
	// if ( level.script == "zm_island" )
	// 	zm_perk_utility::place_perk_machine( ( 2539, 469, -175 ), ( 0, 130, 0 ), PERK_WIDOWS_WINE, WIDOWS_WINE_MACHINE_DISABLED_MODEL );
	// if ( level.script == "zm_stalingrad" )
		zm_perk_utility::place_perk_machine( ( 529, 1240, 176 ), ( 0, 220, 0 ), PERK_WIDOWS_WINE, WIDOWS_WINE_MACHINE_DISABLED_MODEL );
