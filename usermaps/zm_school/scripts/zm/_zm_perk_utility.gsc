...
function create_perk_hud( perk )
{
	...
	if ( perk == "specialty_vultureaid" )
	{
		...
		hud_glow.sort = 1;
		hud_glow.hidewheninmenu = 0;
		hud_glow.alignX = "left";
		hud_glow.alignY = "bottom";
		hud_glow.horzAlign = "left";
		hud_glow.vertAlign = "bottom";
		hud_glow.x = 10 + ( self.perk_hud.size * 30 ) - 12;
		hud_glow.y = hud_glow.y - 60 + 12;
		hud_glow.alpha = 0;
	...
	hud.x = 10 + ( self.perk_hud.size * 30 );
	hud.y = hud.y - 60;
	hud.alpha = 0;
